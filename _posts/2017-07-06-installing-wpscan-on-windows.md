...
WPScan — утилита, которая служит помощником в поиске уязвимостей на сайтах под управлением CMS Wordpress. Она входит в состав инструментария операционной системы Kali Linux. Некоторые инструменты для пентестинга
